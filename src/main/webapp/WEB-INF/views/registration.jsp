            ...
            <sf:form action="addUser" method="post" class="form-horizontal">
                <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="textinput" name="nameUser" value="${errorValN}" placeholder="Insert your Name" class="form-control input-md" required="" type="text">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="textinput" name="phoneUser" value="${errorValP}" placeholder="Insert your phone number" class="form-control input-md" required="" type="text">
                            <span class="help-block"> </span>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="textinput" name="emailUser" value="${errorValE}" placeholder="Insert your Email" class="form-control input-md" required="" type="email">
                            <span class="help-block"> </span>
                                <c:if test="${errorE}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="textinput" name="p1" value="${errorValP1}" placeholder="Insert your Password" class="form-control input-md" required="" type="password">
                            <span class="help-block"> </span>
                                <c:if test="${errorP}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input id="textinput" name="p2" value="${errorValP2}" placeholder="Confirm your Password" class="form-control input-md" required="" type="password">
                            <span class="help-block"> </span>
                                <c:if test="${errorP}">
                                    <p style="color: red">Passwords are different!!</p>
                                </c:if>
